...
default_client_id=0f7eb41392ba4ed
default_access_token=a5cee2b73e179d3282b813a59a5746c3f3d62930

client_id="${IMGUR_CLIENT_ID:=$default_client_id}"
access_token="${IMGUR_ACCESS_TOKEN:=$default_access_token}"
...
function upload {
        curl -s -H "Authorization: Bearer $access_token" -H "Expect: " -F "image=$1" https://api.imgur.com/3/image.xml
